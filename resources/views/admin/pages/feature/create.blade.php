...
@section('content')
    ...
    <form class="form-horizontal" method="POST" action="/feature/store" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            <div class="p-20">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea type="text" class="form-control summernote" name="featureDescription"
                                ...
                                <div class="form-group row">
                                    <label>Feature Title</label>
                                    <input type="text" class="form-control" name="featureTitle2" required>
                                </div>
                                <div class="form-group row">
                                    <label>Feature Description</label>
                                    <div class="col-sm-12">
                                        <textarea type="text" class="form-control summernote" name="featureDescription2"
                                                  rows="15" style="height: 200px;" required></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label>Feature Title</label>
                                    <input type="text" class="form-control" name="featureTitle3" required>
                                </div>
                                <div class="form-group row">
                                    <label>Feature Description</label>
                                    <div class="col-sm-12">
                                        <textarea type="text" class="form-control summernote" name="featureDescription3"
                                                  rows="15" style="height: 200px;" required></textarea>
                                    </div>
                                </div>
                            </div>
